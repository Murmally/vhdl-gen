...
architecture DES1_Sbox_architecture of DES1_Sbox is
begin
process (INPUT)
begin
	case INPUT is
		...
		when "000111" => OUTPUT <= "0100";
		when "001000" => OUTPUT <= "0010";
		when "001001" => OUTPUT <= "1110";
		...
		when "010101" => OUTPUT <= "1100";
		when "010110" => OUTPUT <= "1100";
		when "010111" => OUTPUT <= "1011";
		when "011000" => OUTPUT <= "0101";
		when "011001" => OUTPUT <= "1001";
		when "011010" => OUTPUT <= "1001";
		when "011011" => OUTPUT <= "0101";
		when "011100" => OUTPUT <= "0000";
