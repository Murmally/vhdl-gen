...
entity DES7_Sbox_architecture is
port (
	INPUT : in std_logic_vector(7 downto 0);
	OUTPUT: out std_logic_vector(7 downto 0));
end DES7_Sbox_architecture;

architecture ARCHITECTURE_NAME of DES7_Sbox_architecture is
begin
process (INPUT)
begin
	case INPUT is
		...
		when "001010" => OUTPUT <= "0000";
		when "001011" => OUTPUT <= "1001";
		when "001100" => OUTPUT <= "1000";
		when "001101" => OUTPUT <= "0001";
		when "001110" => OUTPUT <= "1101";
		when "001111" => OUTPUT <= "1010";
		when "010000" => OUTPUT <= "0011";
		when "010001" => OUTPUT <= "1110";
		when "010010" => OUTPUT <= "1100";
		when "010011" => OUTPUT <= "0011";
		when "010100" => OUTPUT <= "1001";
		...
		when "011100" => OUTPUT <= "0110";
		when "011101" => OUTPUT <= "1000";
		when "011110" => OUTPUT <= "0001";
		when "011111" => OUTPUT <= "0110";
		when "100000" => OUTPUT <= "0001";
		when "100001" => OUTPUT <= "0110";
		when "100010" => OUTPUT <= "0100";
		when "100011" => OUTPUT <= "1011";
		...
		when "101010" => OUTPUT <= "0011";
		when "101011" => OUTPUT <= "0100";
		when "101100" => OUTPUT <= "0111";
		when "101101" => OUTPUT <= "1010";
		when "101110" => OUTPUT <= "1110";
		when "101111" => OUTPUT <= "0111";
		when "110000" => OUTPUT <= "1010";
		when "110001" => OUTPUT <= "1001";
		when "110010" => OUTPUT <= "1111";
		when "110011" => OUTPUT <= "0101";
